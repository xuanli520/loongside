...
[Provider Guides](/use-loongclaw/provider-guides/index). Keep
[Provider Recipes](/use-loongclaw/provider-recipes) for representative rollout
...
| follow provider-specific config walkthroughs | [Provider Guides](/use-loongclaw/provider-guides/index) and [Provider Recipes](/use-loongclaw/provider-recipes) |
...
| follow channel setup and smoke-test paths | [Channel Guides](/use-loongclaw/channel-guides/index), [Channel Recipes](/use-loongclaw/channel-recipes), and [Channel Setup](/use-loongclaw/channel-setup) |
