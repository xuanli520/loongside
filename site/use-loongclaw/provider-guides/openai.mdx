---
title: OpenAI
description: Configure the OpenAI provider profile in LoongClaw.
---

# OpenAI

Use this when your team already runs on OpenAI and you want that vendor family to stay explicit in LoongClaw config instead of disappearing behind a generic compatibility route.
