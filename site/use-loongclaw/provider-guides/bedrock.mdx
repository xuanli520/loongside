---
title: Bedrock
description: Configure the Bedrock provider profile in LoongClaw.
---

# Bedrock

Use this when LoongClaw should talk to AWS Bedrock through the Converse path and region ownership needs to stay explicit.
