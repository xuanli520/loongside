---
title: Custom
description: Configure the Custom provider profile in LoongClaw.
---

# Custom

Use this when the real endpoint is OpenAI-compatible but does not map cleanly to one of LoongClaw's built-in provider families.
