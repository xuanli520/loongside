---
title: WeCom
description: Configure the WeCom channel surface in LoongClaw.
---
...
- LoongClaw documents WeCom as the official AIBot long-connection lane. Do not describe a webhook callback mode as if it were the same shipped contract.
