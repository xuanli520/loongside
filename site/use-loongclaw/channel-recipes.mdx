...
Keep [Channel Guides](/use-loongclaw/channel-guides/index) open when you need
...
| WhatsApp should own a Cloud API reply loop | [WhatsApp guide](/use-loongclaw/channel-guides/whatsapp) |
...
| a WhatsApp Cloud runtime | [WhatsApp guide](/use-loongclaw/channel-guides/whatsapp) | shipped Cloud API send plus verified webhook reply loop |
...
| --- | --- | --- |
| runtime-backed service channels | Feishu / Lark, Telegram, Matrix, WhatsApp, WeCom | Recipes 1 to 4 plus the [WhatsApp guide](/use-loongclaw/channel-guides/whatsapp) |
...
- Use [Channel Guides](/use-loongclaw/channel-guides/index) when you need the exact built-in contract for one surface.
...
| inspect the full shipped channel matrix | [Channel Guides](/use-loongclaw/channel-guides/index) |
...
| go fix the provider lane first | [Providers And Models](/use-loongclaw/providers-and-models), [Provider Guides](/use-loongclaw/provider-guides/index), and [Provider Recipes](/use-loongclaw/provider-recipes) |
