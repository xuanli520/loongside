...
| Surface family | Current examples | Representative recipe |
| --- | --- | --- |
| runtime-backed service channels | Feishu / Lark, Telegram, Matrix, WeCom | Recipes 1 to 4 |
| workplace outbound surfaces | Slack, Discord, Microsoft Teams, Google Chat, Mattermost, Nextcloud Talk, Synology Chat | Recipe 6 |
| messaging and bridge outbound surfaces | LINE, DingTalk, WhatsApp, Signal, IRC, iMessage / BlueBubbles, Nostr, Tlon | Recipe 6 |
...
- Keep webhook, email, Slack, Discord, Teams, Google Chat, Mattermost, Nextcloud Talk, Synology Chat, LINE, DingTalk, WhatsApp, Signal, IRC, iMessage / BlueBubbles, Nostr, Tlon, and similar sinks in the outbound-only lane.
...
This recipe uses a few representative examples, but the same pattern covers the broader outbound-only catalog: Slack, Discord, Teams, Google Chat, Mattermost, Nextcloud Talk, Synology Chat, LINE, DingTalk, WhatsApp, Signal, IRC, iMessage / BlueBubbles, Nostr, Tlon, Webhook, Email, and Twitch.
...
| messaging and robot lanes | LINE, DingTalk, WhatsApp | channel token, robot webhook, or phone/account identity plus any required secret material | `loong <surface>-send` |
