...
LoongClaw supports a broad hosted-provider catalog. Volcengine and BytePlus
...
| gateway and platform routing | `openrouter`, `cloudflare_ai_gateway`, `vercel_ai_gateway`, `bedrock`, `custom` | a gateway, proxy, or managed route sits between LoongClaw and the upstream models |
...
| Volcengine plus WeCom | [WeCom Rollout](/use-loongclaw/wecom-rollout-playbook) | hosted provider and the official WeCom lane stay in one path |
...
| inspect the full built-in provider matrix | [Provider Guides](/use-loongclaw/provider-guides/index) |
...
| go straight to concrete channel demos | [Channel Guides](/use-loongclaw/channel-guides/index) and [Channel Recipes](/use-loongclaw/channel-recipes) |
