...
The recipes cover direct hosted providers, coding-specialized lanes, gateway
or compatibility endpoints, local runtimes, and multi-profile patterns.
...
| gateway and platform routing | OpenRouter, Cloudflare AI Gateway, Vercel AI Gateway, Bedrock, Custom | a gateway, proxy, or managed route sits between LoongClaw and the upstream models |
...
- Continue to [Provider Recipes](/use-loongclaw/provider-recipes) for step-by-step hosted, coding-lane, gateway, local, and multi-profile examples.
