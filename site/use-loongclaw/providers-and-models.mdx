...
provider contract lives in [Provider Guides](/use-loongclaw/provider-guides/index),
while [Provider Recipes](/use-loongclaw/provider-recipes) keeps a smaller set
...
- Use [Provider Guides](/use-loongclaw/provider-guides/index) once you know the lane and need the exact built-in contract.
- Use [Provider Recipes](/use-loongclaw/provider-recipes) when you want representative rollout patterns on top of that contract.
...
- Continue to [Provider Guides](/use-loongclaw/provider-guides/index) for the full built-in provider matrix.
