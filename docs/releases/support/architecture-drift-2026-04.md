...
## Summary
- Generated at: 2026-04-14T04:25:11Z
...
| channel_registry | `structural_size` | `crates/app/src/channel/registry.rs` | 9705 | 10500 | 795 | 77 | 90 | 13 | 92.4% | WATCH | 9922 | -2.2% | PASS | 88 |
| channel_config | `structural_size` | `crates/app/src/config/channels.rs` | 8791 | 9800 | 1009 | 17 | 90 | 73 | 89.7% | WATCH | 9796 | -10.3% | PASS | 90 |
...
| channel_mod | `structural_size,operational_density` | `crates/app/src/channel/mod.rs` | 2042 | 6400 | 4358 | 0 | 110 | 110 | 31.9% | HEALTHY | 1779 | 14.8% | BREACH | 0 |
...
- WATCH hotspots (>=85% and <95% of any tracked budget): acp_manager (86.0%), channel_registry (92.4%), channel_config (89.7%), chat_runtime (90.3%), tools_mod (94.7%), daemon_lib (87.4%), onboard_cli (93.9%)
...
<!-- arch-hotspot key=channel_registry lines=9705 functions=77 -->
<!-- arch-hotspot key=channel_config lines=8791 functions=17 -->
<!-- arch-hotspot key=chat_runtime lines=6595 functions=95 -->
<!-- arch-hotspot key=channel_mod lines=2042 functions=0 -->
